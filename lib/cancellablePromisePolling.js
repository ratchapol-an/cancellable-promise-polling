...
var pollingInstanceNo = 0;
var debugMode = false;
var setDebugMode = function (isDebug) { return (debugMode = isDebug); };
...
var startPolling = function (taskFn, options) {
    if (options === void 0) { options = {}; }
    if (typeof taskFn !== 'function') {
        throw new Error('A task function is not provided');
    }
    options = __assign({}, PollingOptions_1.defaultOptions, options);
